...
<p align="center"><img src="{{ '/assets/board/2026/06/Search-R1/image_5.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
<p align="center"><img src="{{ '/assets/board/2026/06/Search-R1/image_6.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
...
<p align="center"><img src="{{ '/assets/board/2026/06/Search-R1/image_7.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>

확실히 검색된 내용은 손실 계산에서 제외하는 것이 모델 최적화에 효과적임

**Larger Model**

<p align="center"><img src="{{ '/assets/board/2026/06/Search-R1/image_8.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>

Base가 훨씬 더 잘함

**Generation example**

<p align="center"><img src="{{ '/assets/board/2026/06/Search-R1/image_9.png' | prepend: site.baseurl }}"  max-width="100%" height="auto"></p>
